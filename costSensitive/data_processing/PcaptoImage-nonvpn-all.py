...
#path_packet=[['nonvpn','packet-feature-Linear-32-0222\\train','packet-feature-Linear-32-0222\\test']]
...
#path_png = [['packet-feature-Linear-32-0222\\train','png-feature-Linear-32-0222\\train'],['packet-feature-Linear-32-0222\\test','png-feature-Linear-32-0222\\test']]
#PACKET_LEN = 1024
#PNG_SIZE = 32
#ALL_COUNT = 100000


path_packet=[['nonvpn','packet-5-28\\train','packet-5-28\\test']]
path_png = [['packet-5-28\\train','png-5-28\\train'],['packet-5-28\\test','png-5-28\\test']]
    ...
    for p in path_packet:
        ...
        for i, d in enumerate(os.listdir(p[0])):
            ...
            for f in os.listdir(os.path.join(p[0], d)):
                ...
                # print(testsavelist)
                getPacket(dirfulllist, trainsavelist)
